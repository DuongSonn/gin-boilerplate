...
type UserServiceClient interface {
	...
	GetUsers(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetUserResponse], error)
...
func (c *userServiceClient) GetUsers(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetUserResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserService_GetUsersClient = grpc.ServerStreamingClient[GetUserResponse]
...
type UserServiceServer interface {
	...
	GetUsers(*GetUserRequest, grpc.ServerStreamingServer[GetUserResponse]) error
...
func (UnimplementedUserServiceServer) GetUsers(*GetUserRequest, grpc.ServerStreamingServer[GetUserResponse]) error {
...
func _UserService_GetUsers_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(UserServiceServer).GetUsers(m, &grpc.GenericServerStream[GetUserRequest, GetUserResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type UserService_GetUsersServer = grpc.ServerStreamingServer[GetUserResponse]
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "external/user/user.proto",
}
